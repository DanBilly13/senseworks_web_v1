...
export default async function Page({
  ...
  // Test — lp/v1 and lp/v2 only, per Dan's request: a light-grey
  // full-page background (--color-surface) instead of the site's
  // default white, and every Button on the page uses the animated
  // hover treatment by default (an explicit `animated` prop on a given
  // Button still overrides this).
  const isLandingPage = slug[0] === 'lp'

  return (
    <div className={isLandingPage ? 'bg-surface' : undefined}>
